-- ============================================================
-- RED CLUB — Canje de servicios con puntos (paso 2: el resto)
-- ============================================================
-- IMPORTANTE: correr 0018_points_redemption.sql PRIMERO, solo, y dejar
-- que confirme antes de correr este archivo — este usa el valor de
-- enum 'redemption_refund' que agrega el 0018, y Postgres no permite
-- usar un valor de enum recién agregado en la misma transacción en la
-- que se agregó (error 55P04). Ver el comentario del 0018 para el
-- detalle completo.
--
...
-- ------------------------------------------------------------
-- 2. Protección contra doble canje/doble reembolso a nivel de índice
-- ------------------------------------------------------------
...
-- ------------------------------------------------------------
-- 3. Descuento atómico y seguro contra doble gasto
-- ------------------------------------------------------------
...
-- ------------------------------------------------------------
-- 4. Una reserva canjeada, al completarse, NO otorga los puntos
...
-- ------------------------------------------------------------
-- 5. Si una reserva canjeada se cancela, devolver los puntos
-- ------------------------------------------------------------
